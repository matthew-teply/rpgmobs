...
public class ConversationMenu extends ModularUIContainerMenu {
    ...
    public static ModularUI createModularUI(
        ...
        var container = new UIElement()
            ...
            .lss("width", "75%")
            .lss("height", "50%")
            .lss("background", "built-in(ui-mc:BORDER)")
            .lss("padding-all", 10)
            .lss("font-size", FONT_SIZE);

        var title = ConversationMenu.createTitle("Conversation with " + entity.getCustomName().getString());

        var contentContainer = ConversationMenu.createContentContainer(entity);
        var actionsContainer = ConversationMenu.createActionsContainer(entity);
    ...
    private static UIElement createContentContainer(AbstractHumanlikeEntity<?> entity) {
        ...
        contentScrollerView.viewPort.lss("background", "empty");
    ...
    private static UIElement createActionsContainer(AbstractHumanlikeEntity<?> entity) {
        ...
        var relationshipBar = ConversationMenu.createRelationshipBar(entity);
        ...
        topicsScrollerView.viewPort.lss("background", "empty");
